          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {bundles.map((bundle) => (
              <div
                ...
                className="border border-brass/40 bg-cream/50 hover:bg-cream/80 transition-all duration-500 group p-6 md:p-8 flex flex-col cursor-pointer"
              >
                <div className="mb-5">
                  <span className="font-display text-[10px] tracking-[0.2em] uppercase text-brass">
                    Stack Bundle
                  </span>
                  <h2 className="font-display text-sm tracking-[0.15em] uppercase text-espresso mt-2">
                    {bundle.name}
                  </h2>
                </div>
                ...
                <div className="space-y-2 mb-5 flex-1">
                  <p className="font-body text-xs text-saddle uppercase tracking-wider">
                    Includes:
                  </p>
                  <ul className="space-y-1.5">
                    {bundle.contents.map((item, i) => (
                      <li
                        key={i}
                        className="font-body text-sm italic text-saddle flex items-center gap-2"
                      >
                ...
                <p className="font-body text-sm text-saddle/70 leading-relaxed mb-5">
                  {bundle.description}
                </p>
                ...
                <button
                  ...
                  className="w-full bg-espresso hover:bg-brass text-cream hover:text-espresso font-display text-[11px] tracking-[0.2em] uppercase py-3 border border-espresso hover:border-brass transition-all duration-300"
                >
                  Add to Cart
                </button>
              </div>
