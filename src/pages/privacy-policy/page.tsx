        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 md:px-8">
          ...
          {s.content ? (
            <div className="space-y-8">
              <div
                className="font-body text-sm text-saddle leading-relaxed prose-headings:font-display prose-headings:tracking-[0.2em] prose-headings:uppercase prose-headings:text-espresso"
