        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 md:px-8">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <p className="font-body text-sm text-saddle leading-relaxed">
                This Research Use Policy may be updated periodically to reflect changes in regulations, industry standards, or company practices. The effective date of the current policy is January 1, 2026. Continued use of the site following any updates constitutes acceptance of the revised terms.
              </p>
              <p className="font-body text-sm text-saddle leading-relaxed">
